...
倾斜参数 \(c\) 与 \(0\) 的差异并不显著，因为其变异系数 \(0.086/0.1401=0.6\) 较大。事实上，\(c=0.1401\)、\(\alpha=832.85\) 对应于图像两轴夹角为 \(89.99^\circ\)，这与 \(90^\circ\) 非常接近。我们还计算了每个四幅图像组合的纵横比 \(\alpha/\beta\)。纵横比的均值为 \(0.99995\)，样本标准差为 \(0.00012\)，因此它非常接近 \(1\)，即像素近似为正方形。
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{figure6_tea_tin_images}
    \caption{茶叶罐的两幅图像。}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{figure7_reconstructed_views}
